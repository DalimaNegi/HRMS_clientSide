...
export default function EmployeePanel() {
  ...
  let menu = [
    { label: "Dashboard", path: "/employeepanel" },
    { label: "My Profile", path: "/employeepanel/profile" },
    { label: "My Attendance", path: "/employeepanel/attendance" },
    { label: "Payslips", path: "/employeepanel/payslips" },
    { label: "Requests", path: "/employeepanel/requests" },
    { label: "Settings", path: "/employeepanel/settings" },
  ];
